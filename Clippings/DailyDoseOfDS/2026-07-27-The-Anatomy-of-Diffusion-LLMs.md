---
title: "Diffusion LLM（扩散语言模型）结构与原理剖析"
date: 2026-07-27
...
Block Diffusion (BD3-LM)：在 LM1B 上与自回归模型的 Perplexity 差距缩小至 0.5 点以内。

LLaDA (8B)：在 MMLU 上赶平 LLaMA 3，在 TruthfulQA 和 HumanEval 上实现超越。

Dream 7B：已实现通过 SGLang 在生产环境中进行 Serving 推送。
