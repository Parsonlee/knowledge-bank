title: "Kimi K3 中的 Delta Attention 机制：解决 KV Cache 膨胀" date: 2026-07-24 author: "Avi Chawla & Akshay Pachaar" source: "https://mail.google.com/mail/u/0/#inbox/19f962933027e3e6" type: clipping
...
1. 先读后写：向矩阵传入新 Token 的 Key，读取当前记忆对该地址的现有估计值。
2. 只写差值（Delta）：将现有估计值与真正希望存储的 Value 进行对比，仅写入两者的残差（Gap/Delta）。
