...
[mp.weixin.qq.com](https://mp.weixin.qq.com/s/yw8dvG6lKnXNB6sN3kg2AQ)CV开发者都爱看的 极市平台


↑ 点击**蓝字**关注极市平台

![图片](https://image.cubox.pro/cardImg/2023112617062734136/98639.jpg?imageMogr2/quality/90/ignore-error/1)

作者丨nghuyong@知乎（已授权）

来源丨https://zhuanlan.zhihu.com/p/652645925
...
本文将系统介绍如何做一个垂直领域的大模型，包括继续预训练，领域微调数据构建，减缓幻觉，知识召回多个方面。也会介绍整体的系统设计，并串讲一系列相关的论文和产品。\>\>[](http://mp.weixin.qq.com/s?__biz=MzI5MDUyMDIxNA==&mid=2247564839&idx=6&sn=ff2c1ca613b52f97af8ce4ddebe06146&chksm=ec1d13dedb6a9ac8bd166c8f79e62148465e78591f905d184136a146f58cbe88e25d6e2752dd&scene=21#wechat_redirect)[加入极市CV技术交流群，走在计算机视觉的最前沿](http://mp.weixin.qq.com/s?__biz=MzI5MDUyMDIxNA==&mid=2247618084&idx=1&sn=981fa2ed41e2eda97799ae098b7c8907&chksm=ec1de3dddb6a6acb719081ffef32f72b72e7d6416f3504bf7049594b9f34f2d6cf570654ae21&scene=21#wechat_redirect)
...
![图片](https://image.cubox.pro/cardImg/2023112617062872845/43487.jpg?imageMogr2/quality/90/ignore-error/1)

「你会为一个闲聊的玩具买单吗？」

虽然2023年以来几乎很多公司都发出了自己的通用大模型，但是都还停留在"开放闲聊"阶段，这种泛娱乐的方式是不能带来实际生产力的。所以，以"开放闲聊"为产品形态的ChatGPT，"尝鲜"的流量在6月达到巅峰之后，就开始了出现下滑。
![图片](https://image.cubox.pro/cardImg/2023112617062820387/89637.jpg?imageMogr2/quality/90/ignore-error/1)

「大模型不能只会开放闲聊」，人们需要的是能实实在在解决问题，提高生产力和工作效率的工具。
![图片](https://image.cubox.pro/cardImg/2023112617062856720/35288.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617062920394/12321.jpg?imageMogr2/quality/90/ignore-error/1)

**医疗大模型** 医疗大模型能给人们进行问诊，并支持多模态的输入。https://www.jiuyangongshe.com/a/dvb0030135（医联）
![图片](https://image.cubox.pro/cardImg/2023112617062948447/87059.jpg?imageMogr2/quality/90/ignore-error/1)

**教育大模型** 多邻国的教育大模型能提供语言学习上的支持，例如答案解析，学习内容规划等。https://blog.duolingo.com/duolingo-max/ (多邻国)
![图片](https://image.cubox.pro/cardImg/2023112617062975270/53043.jpg?imageMogr2/quality/90/ignore-error/1)

**金融大模型** 金融领域大模型数量众多，基本的应用场景也围绕金融的日常工作，例如研报解读等。
![图片](https://image.cubox.pro/cardImg/2023112617062926807/86314.jpg?imageMogr2/quality/90/ignore-error/1)

### 垂直大模型基本套路

参考通用的大模型的训练流程，可以得出垂直领域大模型的基本套路。
![图片](https://image.cubox.pro/cardImg/2023112617063045480/67998.jpg?imageMogr2/quality/90/ignore-error/1)
...
需要注意的是一般垂直领域大模型**不会直接让模型生成答案** ，而是跟先检索相关的知识，然后基于召回的知识进行回答，也就是基于检索增强的生成（Retrieval Augmented Generation:https://www.promptingguide.ai/techniques/rag , RAG)。这种方式能**减少模型的幻觉** ，**保证答案的时效性** ，还能**快速干预**模型对特定问题的答案。
...
![图片](https://image.cubox.pro/cardImg/2023112617063052352/53295.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063055927/71942.jpg?imageMogr2/quality/90/ignore-error/1)

值得注意的是XuanYuan在训练的过程中还采用了**hybrid-tuning** 的策略，即将预训练的数据(通用+金融领域)以及指令微调的数据(通用+金融领域)混合一起进行训练，而不是拆分成继续预训练+指令微调两个阶段，这样模型能很好回答金融领域的问题，也能保持对一般问题的作答**（论文中的说法，还没有对比实验支撑）**。
...
![图片](https://image.cubox.pro/cardImg/2023112617063055607/64119.jpg?imageMogr2/quality/90/ignore-error/1)
...
但是如果想通过二次预训练进行**语言层面的迁移就会比较难**，没有从零开始训练好。回顾人对语言的学习，如果刚"出生"时候就在学习一门语言，进行听说读写的训练，这就是母语了。会比长大以后再去学习一门外语要容易的多，效果也要好很多。所以基于llama做的中文适配 不如 纯中文训练的baichuan 在中文任务上效果好。
...
Self-Instruct整体流程如下：
![图片](https://image.cubox.pro/cardImg/2023112617063071949/82117.jpg?imageMogr2/quality/90/ignore-error/1)

一条微调数据包括三个部分：指令，输入 和 输出。下面具体介绍如何生成这三个部分。

首先从种子指令（人工编写的指令/业务侧积累的问题）中随机选择一些指令，然后让GPT4参考这些指令，生成一系列类似的指令。
![图片](https://image.cubox.pro/cardImg/2023112617063184719/71027.jpg?imageMogr2/quality/90/ignore-error/1)

有了指令后，再让GPT4判断这个指令是一个"分类"问题还是一个"生成"问题。后面会采用不同的答案生成策略。
![图片](https://image.cubox.pro/cardImg/2023112617063153606/68468.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063129669/91030.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063148901/33565.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063152241/91716.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063190055/60823.jpg?imageMogr2/quality/90/ignore-error/1)

以上是这种方法生成的可用数据。
![图片](https://image.cubox.pro/cardImg/2023112617063258422/58325.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063260854/77600.jpg?imageMogr2/quality/90/ignore-error/1)

### Self-QA

如果连基础的种子指令数据都没有，那就不适于Self-Instruct的方法了。这时候可以尝试Self---QA\[5\]的方法，直接从文档中生成指令数据。整体的流程如下：
![图片](https://image.cubox.pro/cardImg/2023112617063272614/39350.jpg?imageMogr2/quality/90/ignore-error/1)

基本的思想是：首先根据无结构的文档通过GPT4生成可能的指令，然后输入指令和对应的文档再让GPT4生成问题的答案。这里的文档可以直接就是文档语料，也可以从结构的表格数据或者图谱数据中生成无结构的文档数据。
![图片](https://image.cubox.pro/cardImg/2023112617063277163/70524.jpg?imageMogr2/quality/90/ignore-error/1)

基于设计的Prompt就可以让GPT4分别进行指令和答案的生成，由此构成指令微调数据。这些数据还需要进一步通过启发式和规则的方法进行过滤，来提高数据的质量。
![图片](https://image.cubox.pro/cardImg/2023112617063281109/48820.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063327237/54016.jpg?imageMogr2/quality/90/ignore-error/1)

然后从知识图谱中采样一条知识，包括这个知识的全部属性，再设计prompt让GPT4基于这则知识生成指令数据。
![图片](https://image.cubox.pro/cardImg/2023112617063345659/12239.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063343179/89389.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063366628/29682.jpg?imageMogr2/quality/90/ignore-error/1)
...
这里根据问题召回相关的文档，本质**不是一个相似句子召回问题**，因为文档中的回答跟答案的相似度可能是很低的。所以这里应该建模成Dense Passage Retrieval(DPR)\[8\]问题，即根据问题召回能回答问题的相关文档。
![图片](https://image.cubox.pro/cardImg/2023112617063430027/31145.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063469238/13952.jpg?imageMogr2/quality/90/ignore-error/1)

如图所示，直接采用T5对问题和文章进行编码，同样也是对比学习的loss。需要注意的是这里问题和文章是同一个编码器。
![图片](https://image.cubox.pro/cardImg/2023112617063494300/39091.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063455702/13916.jpg?imageMogr2/quality/90/ignore-error/1)

我们也可以对大模型在这个任务上进行微调，训练一个专门根据用户问题生成关键词的大模型。这就是ChatLaw\[11\]中的方案(下图)。
![图片](https://image.cubox.pro/cardImg/2023112617063529611/29811.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063560663/63101.jpg?imageMogr2/quality/90/ignore-error/1)

对于多轮场景下的完整问答任务（问题改写+知识召回）也有相关的数据集，例如下面的Orca，标注了每个问题需要召回的文档以及基于文档的回答。
![图片](https://image.cubox.pro/cardImg/2023112617063637305/21513.jpg?imageMogr2/quality/90/ignore-error/1)

### Knowledge Selection

还需要思考需要召回多少个文档，如何过滤，如何排序？
![图片](https://image.cubox.pro/cardImg/2023112617063663818/26725.jpg?imageMogr2/quality/90/ignore-error/1)

Mozi\[1\]中的实验表明，一个问题的回答，往往分布在多个段落中，更多的召回有助于给出更综合的回答。但是随着召回文章的上升，回答的召回率提升，但是不相关的片段也更多，会导致精确率下降。**召回3-4个文档**是较优的折中方案。

同样我们也可以利用大模型对召回的结果进行二次的精排（过滤）。例如下图ChatDoctor\[9\]中的方案，编写prompt让模型在召回的文档中选择对回答问题有帮助的文档。
![图片](https://image.cubox.pro/cardImg/2023112617063724219/86292.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063757683/33725.jpg?imageMogr2/quality/90/ignore-error/1)

下面是ChatLaw\[10\]的系统架构，包括Kyeword LLM 和 ChatLaw LLM两个大模型和一个召回模块。
![图片](https://image.cubox.pro/cardImg/2023112617063793728/18000.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063736087/18040.jpg?imageMogr2/quality/90/ignore-error/1)
...
![图片](https://image.cubox.pro/cardImg/2023112617063754439/61998.jpg?imageMogr2/quality/90/ignore-error/1)
