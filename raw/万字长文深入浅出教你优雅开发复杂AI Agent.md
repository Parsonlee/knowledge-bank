...
[mp.weixin.qq.com](https://mp.weixin.qq.com/s?__biz=MjM5ODYwMjI2MA==&mid=2649794129&idx=1&sn=8d1bcb2faee434e9754c84974e2dc743)腾讯程序员 腾讯技术工程
...
![](https://image.cubox.pro/cardImg/o5wcvqmvfyova8g2lg8vepehnyhfg980o82ct7u0tzkcaiuvj?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/50vfx5yj2aeb6buy5cmmurjq6x91n7bcjv90yz56bylv33vmd3?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/14893yedqeiutlcwx96hi0208bfel0c1p5ppddm7mlk0oviof6?imageMogr2/quality/90/format/gif/ignore-error/1)
...
1.
   **专业判断** : 在关键决策节点，人类可以基于丰富的经验和领域知识，提供更可靠的判断和指导。
2.
   **质量把控** : 人类可以审核和验证AI Agent的输出结果，确保其符合业务需求和质量标准。
3.
   **异常处理** : 当AI Agent遇到无法处理的复杂情况时，人类可以介入并提供解决方案。
4.
   **持续优化** : 通过观察AI Agent的表现，人类可以识别系统的不足，并对Agent的能力边界和工作流程进行调整和优化。
...
![](https://image.cubox.pro/cardImg/587v259o8g4jg9c911k7w4gah0jkp2htbn8cpdr6coi9kagkrx?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/x4cgb8ll2zi9hjm7c9l7vs5n1iv8eip779cv6oo6ouh4bk9ll?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/4uchl0h2rc7pwibyel68o85zgga3861k9qfelxbb3kvvmcxzpx?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/1ljjvdbvhzzqsai3xb1zqkwel4tbevuvb3n90bt57jgrcdra50?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/34nqih13b31c5rkfdmgi6n7da6abcgdxwucay0fqq21bi9blr?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/5gv9bcgtcv8a2rvz96pxzoty3jnmjt1ecjf3hc9b13ifprmhck?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/2guzduuak8siagc01xsg4rryg848g2t12lnpho8oqfazvwtliq?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/3oashbxr4mxc33aimgto46kcfsxzs498ifl6rdopaigh56qz5s?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/5hhhivs9uxb5f3zwt5n6s4t1g39lxerr8wbym2fbc61smyhae7?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/78kx1sogvxxqcc7hy6toqrqow6rnp371zeitxl93vwpcxddhz?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/5q86g8psj40ormlmemnw5dfwx6923wgao1vs3or9h1xifgmfqd?imageMogr2/quality/90/format/gif/ignore-error/1)
...
*
  ToolsNode是一个用于扩展模型能力的组件，它允许模型调用外部工具来完成特定的任务。
...
![](https://image.cubox.pro/cardImg/4ed9nkgsaui5mbpwz8tl3quofakzmtdyzu92j32afg1kld0qmw?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/8ii2hhnzmpcr3uasyitd7bmlkpuppbyyx9dm2latlcrblknj8?imageMogr2/quality/90/format/gif/ignore-error/1)
...
![](https://image.cubox.pro/cardImg/1q9ohf4uv5iljm4gxfmaqkf5hdjx8hrbukbps7c0p3zg7sbmqk?imageMogr2/quality/90/format/gif/ignore-error/1)

\#\#\#\#\## Graph：运行图

以一个简单的查询天气的例子介绍如何使用图编排

![](https://image.cubox.pro/cardImg/1br6g7m754pdmp1fh094gyy0q9q9z98czb0awhd41l1g4gax3y?imageMogr2/quality/90/format/gif/ignore-error/1)
...
当Agent需要使用工具的时候，可以通过在HumanInTheLoop节点里返回compose.InterruptAndRerun错误，让框架自动保存当前的运行状态到CheckPointStore里完成流程中断。当用户完成输入后，通过WithCheckPointID指定当前的CheckPointID重新恢复运行状态，继续往下执行之前的流程。
...
1.
   实现任务状态同步能力，通过Callbacks切面将任务开始、任务结束，以及中间执行状态流式消息进行输出。
2.
   实现TaskProcessor接口处理新任务，内部通过调用graph.Stream执行运行图。
...
1.
   完成AgentCard描述Agent的能力，创建A2A Server
...
旅行规划 Agent 使用经典的 ReAct 框架实现。主要集成了高德地图 MCP 能力，实现了路线规划、交通方式推荐、实时路况查询等功能，以及 Tavily 进行 AI 搜索，能够检索目的地的景点介绍、游玩攻略、美食推荐等内容。在此之上，通过增加了Lambda:user_input节点等待用户下一轮对于行程规划的建议和追问。

\#\#\#\#\## 深度搜索


深度搜索 Agent 利用大模型对复杂问题进行多角度分析，边推理边搜索。在执行流程内部，通过ChatModel:think进行问题分析，并判断上下文的资料是否足够回答用户问题，如果不够那么输出关键词借助搜索工具获取资料补充上下文，如果足够，通过ChatModel:summary模型，输出对于问题的分析总结报告。
...
1.
   实现chat/completion接口，获取model作为Agent名字，调用A2AServer，将任务执行结果，使用SSE协议流式输出到chat/completion响应里
...
1.
   注册QQ机器人，接入[BotGoSDK](https://github.com/tencent-connect/botgo)，接收用户给机器人发送的消息事件。
2.
   接收到消息后，使用A2A协议往Agent发送任务，流式接受任务执行结果状态更新。
3.
   调用发消息OpenAI，可以实现QQ机器人以流式的方式回复用户消息。
