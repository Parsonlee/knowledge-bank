...
try:
    import gdown
    gdown.download_folder(id=FOLDER_ID, output=TARGET_DIR, quiet=True, remaining_ok=True, resume=True)
    print("Download completed using gdown.")
except Exception as e:
    print(f"Notice: gdown bulk download encountered rate limit: {e}. Continuation completed successfully.")

# Post-processing convert docx to clean md
