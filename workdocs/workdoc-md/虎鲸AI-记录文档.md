...
![descript](media/虎鲸AI-记录文档/media/image1.png){width="1.1048917322834646in"
height="1.6843952318460194in"}![descript](media/虎鲸AI-记录文档/media/image2.png){width="4.21875in"
...
![descript](media/虎鲸AI-记录文档/media/image3.png){width="2.3221412948381452in"
height="2.2916666666666665in"}图1-配置**近义词重庆仓：**[gpt会认为重庆=重庆仓=重庆药业仓]{.underline}

![descript](media/虎鲸AI-记录文档/media/image4.png){width="2.21875in"
height="2.2553805774278217in"}![descript](media/虎鲸AI-记录文档/media/image5.png){width="2.1354166666666665in"
height="1.6681080489938758in"}图2-（[多轮对话+前端按钮？]{.underline}）

3.  **多轮对话和近义词歧义词无法共存**

![descript](media/虎鲸AI-记录文档/media/image6.png){width="4.65625in"
height="0.8513615485564304in"}

![descript](media/虎鲸AI-记录文档/media/image7.png){width="2.701788057742782in"
...
![descript](media/虎鲸AI-记录文档/media/image8.png){width="2.2488659230096237in"
...
![descript](media/虎鲸AI-记录文档/media/image9.png){width="3.15625in"
height="0.96544072615923in"}检错（[近义词歧义词处理，暂不加入流程]{.underline}）

![descript](media/虎鲸AI-记录文档/media/image10.png){width="3.105520559930009in"
height="0.576839457567804in"}解析+生成

![descript](media/虎鲸AI-记录文档/media/image11.png){width="3.1214916885389328in"
height="0.7258409886264217in"}执行

**架构示意图（新图）**

![descript](media/虎鲸AI-记录文档/media/image12.png){width="6.299305555555556in"
...
![descript](media/虎鲸AI-记录文档/media/image13.png){width="1.90625in"
height="2.1629582239720033in"}

2.  需要用Prompt不断调整，**大体效果不错**

![descript](media/虎鲸AI-记录文档/media/image14.png){width="1.96875in"
...
![descript](media/虎鲸AI-记录文档/media/image15.png){width="1.9037379702537183in"
height="1.75in"}常见近义词-\>继续流程

![descript](media/虎鲸AI-记录文档/media/image16.png){width="1.9478379265091863in"
...
![descript](media/虎鲸AI-记录文档/media/image17.png){width="3.0833333333333335in"
height="2.0256408573928257in"}![descript](media/虎鲸AI-记录文档/media/image18.png){width="3.09375in"
...
![descript](media/虎鲸AI-记录文档/media/image19.png){width="2.6875in"
...
*案例1：*![descript](media/虎鲸AI-记录文档/media/image20.png){width="2.7604166666666665in"
height="0.8754877515310586in"}![descript](media/虎鲸AI-记录文档/media/image21.png){width="2.6354166666666665in"
height="0.9347583114610674in"}

*案例2：*![descript](media/虎鲸AI-记录文档/media/image22.png){width="1.7215726159230096in"
height="1.1507709973753282in"}![descript](media/虎鲸AI-记录文档/media/image23.png){width="0.9291437007874016in"
...
![descript](media/虎鲸AI-记录文档/media/image24.png){width="0.84375in"
height="1.0113976377952756in"}由于nl2sql工具内部的问题，导致结果有误：

![descript](media/虎鲸AI-记录文档/media/image25.png){width="2.0444083552055994in"
height="0.6069335083114611in"}企业店被拆开当作筛选条件，解决（删除biz
ordr yn字段）

加输出指示：![descript](media/虎鲸AI-记录文档/media/image26.png){width="1.3231878827646544in"
height="1.7206408573928258in"}没加指示：![descript](media/虎鲸AI-记录文档/media/image27.png){width="1.15625in"
...
![descript](media/虎鲸AI-记录文档/media/image28.png){width="4.229166666666667in"
...
![descript](media/虎鲸AI-记录文档/media/image29.png){width="1.5399037620297462in"
height="1.5104166666666667in"}

2.  **生成**：SQL(需要查询的数据，包含本期、基期) +
    分析计算函数入参(各列名，时间范围)

![descript](media/虎鲸AI-记录文档/media/image30.png){width="1.2256944444444444in"
height="1.8385422134733158in"}![descript](media/虎鲸AI-记录文档/media/image31.png){width="1.3627548118985127in"
height="1.8451760717410324in"}

3.  **分析报告**：根据问题+贡献度表生成分析报告

![descript](media/虎鲸AI-记录文档/media/image32.png){width="1.0211143919510062in"
height="1.4148272090988627in"}![descript](media/虎鲸AI-记录文档/media/image33.png){width="1.7620286526684164in"
...
![descript](media/虎鲸AI-记录文档/media/image34.png){width="6.299305555555556in"
...
![descript](media/虎鲸AI-记录文档/media/image35.png){width="3.71875in"
height="0.84375in"}![descript](media/虎鲸AI-记录文档/media/image36.png){width="1.53125in"
height="1.6384798775153107in"}

![descript](media/虎鲸AI-记录文档/media/image37.png){width="5.072916666666667in"
...
![descript](media/虎鲸AI-记录文档/media/image38.png){width="2.3906255468066493in"
height="1.7708333333333333in"}一阶段

![descript](media/虎鲸AI-记录文档/media/image39.png){width="3.0416666666666665in"
height="1.3635050306211725in"}![descript](media/虎鲸AI-记录文档/media/image40.png){width="2.9270833333333335in"
...
> ![descript](media/虎鲸AI-记录文档/media/image41.png){width="3.3333333333333335in"
...
>
> ![descript](media/虎鲸AI-记录文档/media/image42.png){width="3.4583333333333335in"
...
> ![descript](media/虎鲸AI-记录文档/media/image43.png){width="2.8304833770778655in"
...
>
> ![descript](media/虎鲸AI-记录文档/media/image44.png){width="3.2789555993000876in"
> height="2.053066491688539in"}
>
> ![descript](media/虎鲸AI-记录文档/media/image45.png){width="5.458333333333333in"
...
![descript](media/虎鲸AI-记录文档/media/image46.png){width="6.299305555555556in"
...
> ![descript](media/虎鲸AI-记录文档/media/image47.png){width="6.065972222222222in"
> height="2.120865048118985in"}

2.  **parse_query_v2**：RAG检索跟query相近的top5条schema信息，辅助LLM选表

> ![descript](media/虎鲸AI-记录文档/media/image48.png){width="3.1915135608048995in"
...
![descript](media/虎鲸AI-记录文档/media/image49.png){width="7.270833333333333in"
height="2.623746719160105in"}

**主流程**

![descript](media/虎鲸AI-记录文档/media/image50.png){width="7.270833333333333in"
