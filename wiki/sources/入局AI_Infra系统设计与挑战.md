...
tags:
- Infra/AI
summary: 腾讯 QQ 基础架构团队从传统后台工程师视角系统拆解 AI Infra 硬件（GPU 中心化/AI 大型机）、软件（PyTorch/GPU 编程/Python）、训练挑战（显存/模型并行/通信计算重叠）和推理挑战（CUDA
...
---
> 📎 **物理文献**：[[raw/articles/入局AI Infra：程序员必须了解的AI系统设计与挑战知识.md]]